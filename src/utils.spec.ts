...
describe('Utils', () => {
  ...
  describe('#signMessage', () => {
    it('should sign a message', () => {
      const sig = signMessage('hola', '09458c090a69a38368975fb68115df2f4b0ab7d1bc463fc60c67aa1730641d6c');
    ...
    it('should fail to sign with wrong args', () => {
      expect(() => {
        signMessage('hola', '03bec86ad4a8a91fe7c11ec06af27246ec55094db3d86098b7d8b2f12afe47627f');
  ...
  describe('#verifyMessage', () => {
    it('should fail to verify a malformed signature', () => {
      const res = verifyMessage('hola', 'badsignature', '02555a2d45e309c00cc8c5090b6ec533c6880ab2d3bc970b3943def989b3373f16');
      expect(res).to.equal(res);
      expect(res).to.equal(false);
    });
    it('should fail to verify a null signature', () => {
      const res = verifyMessage('hola', null, '02555a2d45e309c00cc8c5090b6ec533c6880ab2d3bc970b3943def989b3373f16');
      expect(res).to.equal(res);
      expect(res).to.equal(false);
    });
    it('should fail to verify with wrong pubkey', () => {
      const res = verifyMessage('hola', '3045022100d6186930e4cd9984e3168e15535e2297988555838ad10126d6c20d4ac0e74eb502201095a6319ea0a0de1f1e5fb50f7bf10b8069de10e0083e23dbbf8de9b8e02785', '02555a2d45e309c00cc8c5090b6ec533c6880ab2d3bc970b3943def989b3373f16');
      expect(res).to.equal(res);
      expect(res).to.equal(false);
    });
    it('should verify', () => {
      const res = verifyMessage('hola', '3045022100d6186930e4cd9984e3168e15535e2297988555838ad10126d6c20d4ac0e74eb502201095a6319ea0a0de1f1e5fb50f7bf10b8069de10e0083e23dbbf8de9b8e02785', '03bec86ad4a8a91fe7c11ec06af27246ec55094db3d86098b7d8b2f12afe47627f');
      expect(res).to.equal(res);
  ...
  describe('#formatAmount', () => {
    it('should successfully format short amount', () => {
      ...
      _.each(cases, (testCase) => {
        expect(formatAmount.apply(this, testCase.args)).to.equal(testCase.expected);
      });
    });
  ...
  describe('#signMessage #verifyMessage round trip', () => {
    it('should sign and verify', () => {
      ...
      const sig = signMessage(msg, '09458c090a69a38368975fb68115df2f4b0ab7d1bc463fc60c67aa1730641d6c');
      expect(verifyMessage(msg, sig, '03bec86ad4a8a91fe7c11ec06af27246ec55094db3d86098b7d8b2f12afe47627f')).to.equal(true);
    });
  });
  ...
  describe('#getProposalHash', () => {
    it('should compute hash for old style proposals', () => {
      const hash = getProposalHash('msj42CCGruhRsFrGATiUuh25dtxYtnpbTx', 1234, 'the message');
      expect(hash).to.equal('msj42CCGruhRsFrGATiUuh25dtxYtnpbTx|1234|the message|');
    });
  ...
  describe('#buildTx', () => {
    const masterPrivateKey = 'tprv8ZgxMBicQKsPd8U9aBBJ5J2v8XMwKwZvf8qcu2gLK5FRrsrPeSgkEcNHqKx4zwv6cP536m68q2UD7wVM24zdSCpaJRmpowaeJTeVMXL5v5k';
    ...
    it('should build a BTC transaction correctly (BIP44)', function() {
      ...
      const utxos = generateUtxos('P2PKH', publicKeyRing, 'm/1/0', 1, [1000, 2000]);
      const txp = {
        version: '2.0.0',
        inputs: utxos,
        toAddress: toAddress,
