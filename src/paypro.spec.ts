...
describe('Paypro', () => {
  ...
  it('should create a Payment Protocol payment', () => {
    ...
    var payment = pp.createPayment(data.merchant_data, '12ab1234', 'mwRGmB4NE3bG4EbXJKTHf8uvodoUtMCRhZ', 100, 'btc');
    var s = '';
    for (var i = 0; i < payment.length; i++) {
      s += payment[i].toString(16);
    }
    expect(s).to.equal('a4c7b22696e766f6963654964223a22436962454a4a74473174394837374b6d4d3631453274222c226d65726368616e744964223a22444766754344656f66556e576a446d5537454c634568227d12412ab12341a1d864121976a914ae6eeec7e05624db748f9c16cce6fb53696ab3988ac');
  });
