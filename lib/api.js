...
/**
 * Get a specific address object from a specific wallet.
 *
 * @param {String} address - The address.
 * @param {String} walletId - The wallet id.
 * @param {Callback} cb
 * @returns {Callback} cb - Return error or an Address
 */
API.prototype.getAddressFromWallet = function(walletId, address, cb) {
